...
- Where dedup fits in API workflows: `n8n-error-handling` `references/API_WORKFLOWS.md`.
- `alwaysOutputData: true` rule: `n8n-node-configuration` and the SDK reference's "Handle empty outputs."
