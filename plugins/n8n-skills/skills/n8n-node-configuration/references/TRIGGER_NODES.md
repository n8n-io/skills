...
Pick schema-defined unless the input shape is genuinely free-form or requires binary passthrough. The schema is the API. Document inputs/outputs in the workflow `description` per `n8n-subworkflows`.
