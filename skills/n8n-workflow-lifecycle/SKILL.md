...
- **Tags:** browsable in the UI and now also queryable via MCP (`list_tags` to enumerate, `search_workflows({ tags: [...] })` to filter). Useful for both human browsing and agent-driven discovery.
