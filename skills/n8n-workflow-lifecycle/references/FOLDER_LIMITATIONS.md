...
> 4. Build a folder-creation MCP extension once, then I'll create folders directly going forward. n8n's REST API has a Folders endpoint (https://docs.n8n.io/api/api-reference/#tag/folders), so this is a one-time wrap. See `n8n-extending-mcp`.
>
